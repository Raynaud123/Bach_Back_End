...
//
//        List<Keyword> lijstK1= new ArrayList<Keyword>();    lijstK1.add(k1);
//        List<Keyword> lijstK2= new ArrayList<Keyword>();    lijstK2.add(k1);    lijstK2.add(k2);
//        List<Keyword> lijstK3= new ArrayList<Keyword>();    lijstK3.add(k1);    lijstK3.add(k2);    lijstK3.add(k3);
//        List<Keyword> lijstK4= new ArrayList<Keyword>();    lijstK4.add(k1);    lijstK4.add(k2);    lijstK4.add(k3);    lijstK4.add(k4);    lijstK4.add(k5);
//        List<Keyword> lijstK5= new ArrayList<Keyword>();
//
//        List<TargetAudience> lijstTA1 = new ArrayList<TargetAudience>();    lijstTA1.add(t1);
//        List<TargetAudience> lijstTA2 = new ArrayList<TargetAudience>();    lijstTA2.add(t1);       lijstTA2.add(t2);
//        List<TargetAudience> lijstTA3 = new ArrayList<TargetAudience>();    lijstTA3.add(t1);       lijstTA3.add(t2);       lijstTA3.add(t3);
//        List<TargetAudience> lijstTA4 = new ArrayList<TargetAudience>();    lijstTA4.add(t1);       lijstTA4.add(t3);
//        List<TargetAudience> lijstTA5 = new ArrayList<TargetAudience>();    lijstTA5.add(t2);
//
//
//        return args -> {
//            Topic topic1 = new Topic(
//                    1L, "Device Security Management",
//                    20L, 10L, 40L, 2L, lijstK1, null, lijstTA1, true, false,
...
//                    21L, 11L, 40L, 1L, lijstK2, null, lijstTA2, true, false,
...
//                    22L, 12L, 40L, 2L, lijstK3, null, lijstTA3, true, false,
...
//                    23L, 13L, 41L, 1L, lijstK4, null, lijstTA4, true, false,
...
//                    24L, 14L, 41L, 1L, lijstK5, null, lijstTA5, true, false,
