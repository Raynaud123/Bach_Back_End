...
//            Course co4 = new Course("Elektromechanica - Elektromechanica", "EMem");
//            Course co5 = new Course("Elektromechanica - Energie", "EMen");
//            Course co6 = new Course("Chemie - Chemie", "CHch");
//            Course co7 = new Course("Chemie - Biochemie", "CHbio");
//            Course co8 = new Course("Bouwkunde - Bouwkunde", "BWbw");
//            Course co9 = new Course("Bouwkunde - Landmeten", "BWland");
//
