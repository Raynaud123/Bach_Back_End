...
//                    11L, "Research1", passwordEncoder.encode("research"), "research1@gmail.com", "+32400000000", COMPANY, false, true, "Belgium", "Ghent", "StreetNameReseach1", 9000, 2, true, false, "ReseachGroup1", c1, lijstT1
//            );
//            TopicProvider topicprovider2 = new TopicProvider(
//                    12L, "Research2", passwordEncoder.encode("research"), "research2@gmail.com", "+32400000000", COMPANY, false, true, "Belgium", "Ghent", "StreetNameReseach2", 9000, 3, true, false, "ReseachGroup2", c2, lijstT2
//            );
//            TopicProvider topicprovider3 = new TopicProvider(
//                    13L, "Research3", passwordEncoder.encode("research"), "research3@gmail.com", "+32400000000", COMPANY, false, true, "Belgium", "Ghent", "StreetNameReseach3", 9000, 4, true, false, "ReseachGroup3", c3, lijstT3
//            );
//            TopicProvider topicprovider4 = new TopicProvider(
//                    14L, "Company1", passwordEncoder.encode("company"), "company1@gmail.com", "+32400000000", COMPANY, false, true, "Belgium", "Ghent", "StreetNameCompany1", 9000, 5, true, true, "Company1", null, lijstT4
//            );
//            TopicProvider topicprovider5 = new TopicProvider(
//                    15L, "Company2", passwordEncoder.encode("company"), "company2@gmail.com", "+32400000000", COMPANY, false, true, "Belgium", "Ghent", "StreetNameCompany2", 9000, 6, true, true, "Company2", null, lijstT5
//            );
//            TopicProvider topicprovider6 = new TopicProvider(
//                    16L, "Company3", passwordEncoder.encode("company"), "company3@gmail.com", "+32400000000", COMPANY, false, true, "Belgium", "Ghent", "StreetNameCompany3", 9000, 7, true, true, "Company3", null, null
//            );
//            repository.saveAll(
